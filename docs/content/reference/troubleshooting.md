...
Most of these come down to network reality or how boredapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

boredapi rate-limits like any public site. boredapi already paces
...
Where a surface is gated, boredapi reads a cookie or token you supply
...
`boredapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what boredapi actually did
